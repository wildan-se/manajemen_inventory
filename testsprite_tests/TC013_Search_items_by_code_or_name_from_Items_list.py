...
async def run_test():
    ...
    try:
        ...
        # -> Type the email and password into the form and click the 'Log in' button.
        ...
        # -> Click the 'Items / Material' menu link (index 555) to open the Items list so the search field can be used.
        frame = context.pages[-1]
        # Click element
