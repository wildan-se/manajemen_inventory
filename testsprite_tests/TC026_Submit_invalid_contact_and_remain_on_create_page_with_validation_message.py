...
async def run_test():
    ...
    try:
        ...
        # -> Type the email into the Email field (index 64)
        ...
        # -> Click the 'Supplier' navigation link in the sidebar to open the Suppliers list or creation page (click element index 3185).
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('text=Please enter a valid contact').first).to_be_visible(timeout=3000)
