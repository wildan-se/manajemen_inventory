...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field (index 64), type the password into the password field (index 74), then click the 'Log in' button (index 95).
        ...
        assert '/warehouses' in frame.url
